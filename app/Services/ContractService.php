...
class ContractService
{
    ...
    private array $translations = [
        'fr' => [
            ...
            'art3_body'      => "Le financement accordé par AURENZA CAPITAL est soumis à un taux d'intérêt annuel de : {taux} %.\nLes intérêts sont calculés conformément aux conditions du présent contrat.",
            ...
            'made_at'        => 'Fait le',
            'sig_lender'     => 'POUR AURENZA CAPITAL',
        ...
        'pl' => [
            ...
            'art3_body'      => "Finansowanie udzielone przez AURENZA CAPITAL podlega rocznej stopie procentowej wynoszącej : {taux} %.",
            ...
            'sig_lender'     => 'W IMIENIU AURENZA CAPITAL',
        ...
        'en' => [
            ...
            'art1_body'      => "This agreement defines the conditions under which AURENZA CAPITAL grants financing totalling {montant} {devise} to the Borrower {nom_client}.\nThe funds will be made available after full validation of the file and acceptance of these contractual conditions.",
            ...
            'art3_body'      => "The financing granted by AURENZA CAPITAL is subject to an annual interest rate of: {taux} %.",
            ...
            'made_at'        => 'Signed on',
            'sig_lender'     => 'FOR AURENZA CAPITAL',
        ...
        'es' => [
            ...
            'art1_body'      => "El presente contrato define las condiciones bajo las cuales AURENZA CAPITAL concede una financiación por un importe total de {montant} {devise} al Prestatario {nom_client}.\nLos fondos se pondrán a disposición tras la validación completa del expediente.",
            ...
            'art3_body'      => "La financiación concedida por AURENZA CAPITAL está sujeta a un tipo de interés anual del: {taux} %.",
            ...
            'made_at'        => 'Firmado el',
            'sig_lender'     => 'POR AURENZA CAPITAL',
    ...
    public function getVariables(LoanRequest $loan): array
    {
        ...
        return array_merge([
            ...
            '{agent_suivi}'     => $loan->agent_suivi ?: ($admin?->name ?? 'AURENZA CAPITAL'),
