...
class ContractService
{
    ...
    private array $translations = [
        'fr' => [
            ...
            'art3_body'      => "Le financement accordé par AURENZA CAPITAL INVESTI est soumis à un taux d'intérêt annuel de : {taux} %.\nLes intérêts sont calculés conformément aux conditions du présent contrat.",
            ...
            'made_at'        => 'Fait le',
            'sig_lender'     => 'POUR AURENZA CAPITAL INVESTI',
        ...
        'pl' => [
            ...
            'art3_body'      => "Finansowanie udzielone przez AURENZA CAPITAL INVESTI podlega rocznej stopie procentowej wynoszącej : {taux} %.",
            ...
            'sig_lender'     => 'W IMIENIU AURENZA CAPITAL INVESTI',
        ...
        'en' => [
            ...
            'art1_body'      => "This agreement defines the conditions under which AURENZA CAPITAL INVESTI grants financing totalling {montant} {devise} to the Borrower {nom_client}.\nThe funds will be made available after full validation of the file and acceptance of these contractual conditions.",
            ...
            'art3_body'      => "The financing granted by AURENZA CAPITAL INVESTI is subject to an annual interest rate of: {taux} %.",
            ...
            'made_at'        => 'Signed on',
            'sig_lender'     => 'FOR AURENZA CAPITAL INVESTI',
        ...
        'es' => [
            ...
            'art1_body'      => "El presente contrato define las condiciones bajo las cuales AURENZA CAPITAL INVESTI concede una financiación por un importe total de {montant} {devise} al Prestatario {nom_client}.\nLos fondos se pondrán a disposición tras la validación completa del expediente.",
            ...
            'art3_body'      => "La financiación concedida por AURENZA CAPITAL INVESTI está sujeta a un tipo de interés anual del: {taux} %.",
            ...
            'made_at'        => 'Firmado el',
            'sig_lender'     => 'POR AURENZA CAPITAL INVESTI',
    ...
    public function getVariables(LoanRequest $loan): array
    {
        ...
        return array_merge([
            ...
            '{agent_suivi}'     => $loan->agent_suivi ?: ($admin?->name ?? 'AURENZA CAPITAL INVESTI'),
            '{montant}'         => number_format((float)$loan->amount, 2, ',', ' '),
            '{devise}'          => $loan->currency ?? config('aurenza.default_currency'),
            '{duree}'           => $loan->darly ?? '',
            ...
            '{date}'            => $loan->validated_at
                                    ...
                                    : now()->format('d/m/Y'),
            '{societe}'         => 'AURENZA CAPITAL INVESTI',
