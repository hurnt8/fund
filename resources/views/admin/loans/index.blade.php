...
.li-search-input:focus{border-color:var(--c-gold);background:#fff;box-shadow:0 0 0 3px rgba(198,161,91,.1)}
...
.li-avatar--client{background:linear-gradient(135deg,var(--c-navy),#1A4A38);color:var(--c-gold-l)}
