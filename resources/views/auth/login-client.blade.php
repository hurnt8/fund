...
<title>{{ __('auth.client_login_title') }} — Aurenza Capital</title>
...
.ls__btn:hover{border-color:rgba(220,190,135,.4);background:rgba(220,190,135,.06)}
...
.ls__menu{
  ...
  background:#0B2C22;border:1.5px solid var(--bdr);
...
.ls__opt.cur{background:rgba(220,190,135,.12);color:var(--brass)}
...
.logo-box span{
  font-family:'Outfit',sans-serif;font-size:2rem;
  font-weight:800;color:#061A14;line-height:1;
}
...
.finput:focus{
  border-color:var(--brass);background:#123A2C;
  box-shadow:0 0 0 3.5px rgba(220,190,135,.15);
}
...
.fforgot{font-size:.78rem;font-weight:600;color:var(--brass);transition:opacity .18s}
...
.fbtn:hover{
  ...
  box-shadow:0 8px 36px rgba(220,190,135,.5),0 2px 10px rgba(0,0,0,.35);
}
...
.alt-link a{color:rgba(220,190,135,.75);font-weight:600;transition:color .18s}
.alt-link a:hover{color:var(--brass)}
...
.qavatar{
  ...
  color:#061A14;letter-spacing:.02em;
  box-shadow:0 0 0 4px rgba(220,190,135,.18);
}
...
#pwa-banner{
  ...
  background:linear-gradient(135deg,rgba(220,190,135,.12),rgba(220,190,135,.05));
...
.pwa-icon{
  ...
  background:linear-gradient(135deg,var(--brass),var(--brass2));
  display:flex;align-items:center;justify-content:center;
  box-shadow:0 4px 14px rgba(220,190,135,.3);
}
...
.pwa-btn{
  ...
  color:#061A14;border:none;border-radius:999px;
...
#pwa-ios{
  display:none;
  margin:0 1.25rem .5rem;
  background:rgba(220,190,135,.07);border:1.5px solid rgba(220,190,135,.2);
...
.ios-step i{color:var(--brass);font-size:.8rem;flex-shrink:0;width:16px;text-align:center}
...
<div class="page-shell">
  ...
  <div id="pwa-ios">
    <div style="font-weight:700;color:var(--text);margin-bottom:.5rem;font-size:.8rem">
      <i class="fas fa-mobile-screen" style="color:var(--brass);margin-right:.4rem"></i>
      Installer l'app Aurenza Capital sur votre iPhone
    </div>
    <div class="ios-step">
      <i class="fas fa-arrow-up-from-bracket"></i>
      <span>Appuyez sur <strong style="color:var(--brass)">Partager</strong> dans Safari</span>
    </div>
    <div class="ios-step">
      <i class="fas fa-plus-square"></i>
      <span>Choisissez <strong style="color:var(--brass)">Sur l'écran d'accueil</strong></span>
    </div>
    <div class="ios-step">
      <i class="fas fa-check-circle"></i>
      <span>Appuyez sur <strong style="color:var(--brass)">Ajouter</strong> — c'est fait !</span>
    </div>
...
document.getElementById('login-form').addEventListener('submit', function() {
  ...
  btn.disabled = true;
  text.innerHTML = '<span style="display:inline-block;width:18px;height:18px;border-radius:50%;border:2.5px solid rgba(8,12,24,.3);border-top-color:#061A14;animation:spin .65s linear infinite;vertical-align:middle"></span>';
