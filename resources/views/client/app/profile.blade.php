  ...
  <div class="ca-settings-list">
    ...
    <div class="ca-settings-item" x-data="langMenu()" @click.stop>
      ...
      <div class="ca-settings-item__text">
        ...
        <div class="ca-settings-item__sub">{{ ['fr'=>'Francais','en'=>'English','pl'=>'Polski','es'=>'Espanol','ro'=>'Romana','hr'=>'Hrvatski','pt'=>'Portugues'][app()->getLocale()] ?? app()->getLocale() }}</div>
      </div>
      ...
      <div x-show="open" @click.outside="close()" x-transition
        ...
        @foreach(['fr'=>'Francais','en'=>'English','pl'=>'Polski','es'=>'Espanol','ro'=>'Romana','hr'=>'Hrvatski','pt'=>'Portugues'] as $lc => $label)
