...
$texts = [
    'fr' => [
        ...
        'intro'    => 'Veuillez trouver ci-joint votre <strong>attestation d\'assurance emprunteur</strong> (référence <strong>'.$loan->reference.'</strong>) établie par CREDIXA INVESTI dans le cadre de votre dossier de financement.',
    ...
    'en' => [
        ...
        'intro'    => 'Please find attached your <strong>borrower insurance certificate</strong> (reference <strong>'.$loan->reference.'</strong>) issued by CREDIXA INVESTI in connection with your financing application.',
    ...
    'es' => [
        ...
        'intro'    => 'Encontrará adjunto su <strong>certificado de seguro de prestatario</strong> (referencia <strong>'.$loan->reference.'</strong>) emitido por CREDIXA INVESTI en el marco de su solicitud de financiación.',
    ...
    'pl' => [
        ...
        'intro'    => 'W załączeniu przesyłamy <strong>zaświadczenie ubezpieczenia kredytobiorcy</strong> (numer referencyjny <strong>'.$loan->reference.'</strong>) wystawione przez CREDIXA INVESTI w ramach Państwa wniosku kredytowego.',
