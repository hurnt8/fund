...
$texts = [
    'fr' => [
        ...
        'intro'    => 'Veuillez trouver ci-joint votre <strong>attestation d\'assurance emprunteur</strong> (référence <strong>'.$loan->reference.'</strong>) établie par AURENZA CAPITAL dans le cadre de votre dossier de financement.',
    ...
    'en' => [
        ...
        'intro'    => 'Please find attached your <strong>borrower insurance certificate</strong> (reference <strong>'.$loan->reference.'</strong>) issued by AURENZA CAPITAL in connection with your financing application.',
    ...
    'es' => [
        ...
        'intro'    => 'Encontrará adjunto su <strong>certificado de seguro de prestatario</strong> (referencia <strong>'.$loan->reference.'</strong>) emitido por AURENZA CAPITAL en el marco de su solicitud de financiación.',
    ...
    'pl' => [
        ...
        'intro'    => 'W załączeniu przesyłamy <strong>zaświadczenie ubezpieczenia kredytobiorcy</strong> (numer referencyjny <strong>'.$loan->reference.'</strong>) wystawione przez AURENZA CAPITAL w ramach Państwa wniosku kredytowego.',
