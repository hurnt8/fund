...
$texts = [
    'fr' => [
        ...
        'intro'        => 'Nous avons bien enregistré votre dossier de financement auprès de **CREDIXA INVESTI**. Vous trouverez ci-joint votre contrat de prêt ainsi que le tableau d\'amortissement détaillant vos remboursements.',
    ...
    'pl' => [
        ...
        'intro'        => 'Zarejestrowaliśmy Państwa wniosek o finansowanie w **CREDIXA INVESTI**. W załączeniu przesyłamy umowę pożyczki oraz harmonogram spłat.',
    ...
    'en' => [
        ...
        'intro'        => 'Your financing file has been registered with **CREDIXA INVESTI**. Please find attached your loan agreement and the amortization schedule detailing your monthly repayments.',
    ...
    'es' => [
        ...
        'intro'        => 'Hemos registrado su expediente de financiación en **CREDIXA INVESTI**. Adjuntamos su contrato de préstamo y el cuadro de amortización con el detalle de sus pagos mensuales.',
