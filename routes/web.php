...
$supportedLocales = ['fr', 'en', 'pl', 'es', 'ro', 'hr'];
...
Route::group(['prefix' => '{locale}', 'middleware' => 'setLocale', 'where' => ['locale' => 'fr|en|pl|es|ro|hr']], function () {
    Route::get('/', function () {
        return view('welcome');
    })->name('home');
...
Route::get('/lang/{lang}', function (Request $request, $lang) {
    if (in_array($lang, ['fr', 'en', 'pl', 'es', 'ro', 'hr'])) {
        session(['locale' => $lang]);
    }
...
Route::middleware(['auth', 'role:client', 'client.locale'])->prefix('app')->name('client.app.')->group(function () {
    ...
    Route::post('/locale', function (\Illuminate\Http\Request $request) {
        ...
        if (in_array($locale, ['fr','en','pl','es','ro','hr'])) {
