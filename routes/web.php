...
$supportedLocales = ['fr', 'en', 'pl', 'es', 'ro', 'hr', 'pt'];
...
Route::group(['prefix' => '{locale}', 'middleware' => 'setLocale', 'where' => ['locale' => 'fr|en|pl|es|ro|hr|pt']], function () {
    Route::get('/', function () {
        return view('welcome');
    })->name('home');
...
Route::get('/lang/{lang}', function (Request $request, $lang) {
    if (in_array($lang, ['fr', 'en', 'pl', 'es', 'ro', 'hr', 'pt'])) {
        session(['locale' => $lang]);
    }
